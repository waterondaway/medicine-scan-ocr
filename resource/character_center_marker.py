...
def save_image(img, filename):
    save_path = os.path.join(output_directory, f"template_image_center_marker.png") # Specific filename
    img.save(save_path)
...
def draw_text_with_red_dots(draw, text, position, font):
    ...
    for char in text:
        ...
        if char != " " and char != "-":
            draw.ellipse((center_x - 1, center_y - 1, center_x + 1, center_y + 1), fill="red") # (initial x-axis, initial y-axis, ending x-axis, ending y-axis)
